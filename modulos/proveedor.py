...
#obsiones
        ...
        self.boton_guardar.place(x=10, y=310, width=230, height=40)
        ...
        self.boton_modificar.place(x=10, y=360, width=230, height=40)

        self.boton_limpiar = tk.Button(labelproveedor, text="Limpiar", font="arial 14 bold", bg="#BA48D6", fg="white", command=self.limpiar_formulario_proveedor)
        self.boton_limpiar.place(x=10, y=410, width=230, height=40)
